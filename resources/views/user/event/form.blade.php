                            ...
                            <div class="card">
                                <div class="card-body p-5 text-center">
                                    ...
                                    <div class="otp-field mb-4">
                                        <input id="otp_1" type="number" />
                                        <input id="otp_2" type="number" disabled />
                                        <input id="otp_3" type="number" disabled />
                                        <input id="otp_4" type="number" disabled />
                                        <input id="otp_5" type="number" disabled />
                                        <input id="otp_6" type="number" disabled />
                                    </div>

                                    <button class="btn btn-primary mb-3 send_otp">
                                        Verify
                                    </button>
...
<div class="container">
    ...
    <form method="post" action="user/event/store" enctype="multipart/form-data" id="userform">
        ...
        <div class="form-group">
            ...
            <input type="file" class="form-control" id="file" name="per_file_{{ $perinfo->index_no }}"
                {{ $perinfo->required == 1 ? 'required' : '' }}>
        </div><br>
        @elseif($perinfo->option_types == 'textarea')
        <div class="form-group">
            <label for="file">{{ $perinfo->name }}</label>
            <textarea id="w3review" class="form-control" name="per_textarea_{{ $perinfo->index_no }}"
                {{ $perinfo->required == 1 ? 'required' : '' }}></textarea>
        </div><br>
        @elseif($perinfo->option_types == 'number')
        <div class="form-group">
            <label for="number">{{ $perinfo->name }}</label>
            <input type="number" class="form-control" id="number" name="per_num_{{ $perinfo->index_no }}"
                {{ $perinfo->required == 1 ? 'required' : '' }}>
        </div><br>
        ...
        <div class="form-group">
            ...
            <input type="number" class="form-control" id="mobile"
                name="per_mobile_{{ $perinfo->index_no }}" {{ $perinfo->required == 1 ? 'required' : '' }}>
        </div><br>
        @elseif($perinfo->option_types == 'dropdown')
        <div class="form-group">
            <label for="inputState">{{ $perinfo->name }}</label>
            <select id="inputState" name="per_dropdown_{{ $perinfo->index_no }}" class="form-control"
                {{ $perinfo->required == 1 ? 'required' : '' }}>
        ...
        <div class="form-group">
            ...
            <div class="custom-control custom-checkbox">
                <input type="checkbox"
                    ...
                    class="custom-control-input" value="{{ $option->index_no }}" id="customCheck1">
        ...
        <div class="form-group">
            ...
            <div class="form-check">
                <input class="form-check-input" type="radio" name="per_radio_{{ $perinfo->index_no }}"
                    id="exampleRadios1{{ $key }}" value="{{ $option->index_no }}"
                    {{ $perinfo->required == 1 ? 'required' : '' }}>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="formGroupExampleInput2"
                name="que_input_{{ $perinfo->index_no }}" {{ $perinfo->required == 1 ? 'required' : '' }}>
        </div><br>
        @elseif($perinfo->option_types == 'textarea')
        <div class="form-group">
            <label for="file">{{ $perinfo->name }}</label>
        ...
        <div class="form-group">
            ...
            <input type="number" class="form-control" id="formGroupExampleNumber2"
                name="que_num_{{ $perinfo->index_no }}" {{ $perinfo->required == 1 ? 'required' : '' }}>
        </div><br>
        @elseif($perinfo->option_types == 'dropdown')
        <div class="form-group">
            <label for="inputState">{{ $perinfo->name }}</label>
        ...
        <div class="form-group">
            ...
            <input type="text" name="event_end" class="form-control datepicker"
                name="que_date_{{ $perinfo->index_no }}" placeholder="Enter ..." id="datepicker2" readonly>
        </div><br>
        @elseif($perinfo->option_types == 'checkbox')
        <div class="form-group">
            <label for="inputState">{{ $perinfo->name }}</label>
        ...
        <div class="form-group">
            ...
            @foreach ($perinfo->options as $option)
            <div class="form-check">
                <input class="form-check-input" type="radio" name="que_radio_{{ $perinfo->index_no }}"
                    id="exampleRadios1{{ $key }}" value="{{ $option->index_no }}"
                    {{ $perinfo->required == 1 ? 'required' : '' }}>
                <label class="form-check-label" for="exampleRadios1{{ $key }}">
                    {{ $option->name }}
