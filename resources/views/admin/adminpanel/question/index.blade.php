            ...
            <div class="container-fluid">
                <div class="row mb-2 align-items-center">
                    ...
                    <div class="col-sm-3 float-sm-right">
                        ...
                        <select class="form-select" name="languages" id="languageDropDown"
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="p_option[]" class="form-control"
                                                placeholder="Enter ..." value="{{ $val->option_name }}"
                                                data-translatable="true" id="p_option_{{ $val->id }}">
                                        </div>
                                    </div>
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="quation[]" class="form-control quation"
                                                placeholder="Enter ..." value="{{ $val->name }}"
                                                data-translatable="true" id="q_quation_{{ $val->id }}">
                                        </div>
                                    </div>
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="option[]" class="form-control"
                                                placeholder="Enter ..." value="{{ $val->option_name }}"
                                                data-translatable="true" id="q_option_{{ $val->id }}">
                                        </div>
                                    </div>
                                    <div class="col-sm-2">
                                        <div class="form-group">
