            ...
            <div class="container-fluid">
                <div class="row mb-2 align-items-center">
                    ...
                    <div class="col-sm-3 float-sm-right">
                        ...
                        <select name="languages" class="form-select" id="languageDropDown"
                            onchange="javascript:languageChangeHandler()" class="form-control">
                ...
                <div class="card shadow-lg">
                    ...
                    <div class="card-body">
                        <form id="event-details" method="post" action="store" enctype="multipart/form-data">
                            ...
                            <div class="row removecls29">
                                <div class="col-sm-4">
                                    <!-- text input -->
                                    <div class="form-group">
                                        <label></label>
                                        <input type="text" name="p_quation[]" class="form-control quation"
                                            placeholder="Question" data-translatable="true" id="p_quation_10"
...
@section('content-js')
    ...
    <script>
        $(document).ready(function() {
            ...
            $(addButton).click(function() {
                ...
                if (x < maxField) {
                    ...
                    control.makeTransliteratable(['q_quation_' + (x + 1)]);
                    control.makeTransliteratable(['q_option_' + (x + 1)]);
                    if ($('#languageDropDown').val() == 'en') {
            ...
            $(addButton2).click(function() {
                ...
                if (y < maxField) {
                    ...
                    // Add newly added input fields to translatable fields
                    control.makeTransliteratable(['p_quation_' + (y + 1)]);
                    control.makeTransliteratable(['p_option_' + (y + 1)]);
        ...
        function languageChangeHandler() {
            ...
            if (dropdown.options[dropdown.selectedIndex].value == "en") {
                $('#p_quation_1').val('Full Name')
                $('#p_quation_2').val('Gender')
                $('#p_quation_3').val('Age')
                $('#p_quation_4').val('Address')
                $('#p_quation_5').val('Pincode')
                $('#p_quation_6').val('Area')
                ...
                $('#p_quation_2').val('લિંગ')
                $('#p_quation_3').val('ઉંમર')
                $('#p_quation_4').val('સરનામું')
                $('#p_quation_5').val('પિનકોડ')
                $('#p_quation_6').val('વિસ્તાર')
                ...
                $('#p_quation_2').val('लिंग')
                $('#p_quation_3').val('आयु')
                $('#p_quation_4').val('पता')
                $('#p_quation_5').val('पिनकोड')
                $('#p_quation_6').val('क्षेत्र')
                ...
                $('#p_quation_2').val('लिंग')
                $('#p_quation_3').val('वय')
                $('#p_quation_4').val('पत्ता')
                $('#p_quation_5').val('पिनकोड')
                $('#p_quation_6').val('क्षेत्रफळ')
                $('#p_quation_7').val('राज्य')
                $('#p_quation_8').val('शहर')
                $('#p_quation_9').val('मोबाइल नंबर')
