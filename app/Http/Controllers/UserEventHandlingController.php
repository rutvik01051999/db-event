...
class UserEventHandlingController extends Controller
{
    ...
    {
        try {
            $data = Event::with('questions', 'personalinfo')
                ->where('event_url', env('APP_URL') . '/' . $id)
                ->first();
    ...
    public function eventDataStore(Request $request)
    {
        ...
        try {
            ...
            foreach ($data->questions as $key => $val) {
                ...
                } elseif ($val->option_types == 'checkbox') {
                    $checkbox = [];
                    foreach ($val->options as $key2 => $val2) {
                        // dd($request->all());
                ...
                } elseif ($val->option_types == 'number') {
                ...
                } elseif ($val->option_types == 'textarea') {
                ...
                } elseif ($val->option_types == 'rating') {
                ...
                } elseif ($val->option_types == 'dropdown') {
